...
#きれいめ　#パーカー、ポロシャツ
CCCC = {"きれい目" : {"Tシャツ":1, "スウェット":0, "ジャケット":0, "パーカー":0, "セーター":0, "カーディガン":0, "コート":0, "ダウンジャケット":0, "シャツ":0, "ポロシャツ":0, "タートルネック":0},
        ...
        "アウトドア" : {"Tシャツ":3, "ジャケット":4, "コート":5, "ダウンジャケット":5},
        "ストリート" : {"Tシャツ":5, "スウェット":5, "ジャケット":4, "パーカー":5, "ダウンジャケット":3, "ポロシャツ":3, "タートルネック":2}
        }

DDDD = {"きれい目" : {"ジーパン":5, "チノパン":5, "スウェットパンツ":3, "カーゴパンツ":4, "スラックス":4, "イージーパンツ":5, "スキニー":6, "フレアパンツ":7, "ショートパンツ":8, "ジョガーパンツ":9, "コーディルー":10, "レザーパンツ":11},
        "アメカジ" : {"ジーパン":5, "チノパン":4, "スウェットパンツ":1, "カーゴパンツ":3, "スキニー":2},
        "ストリート" : {"ジーパン":5, "チノパン":4, "スウェットパンツ":4, "カーゴパンツ":5, "イージーパンツ":1, "ショートパンツ":4, "ジョガーパンツ":2},
        ...
        "アウトドア" : {"ジーパン":2, "チノパン":4, "スウェットパンツ":4, "カーゴパンツ":4, "イージーパンツ":2, "ショートパンツ":2, "ジョガーパンツ":5},
        }
...
###########################################################################################
            ...
            if len(Users) == 0:
                ...
                st.write(Rname + " : " + str(Result))
                st.write(Rname02 + " : " + str(Result02))
