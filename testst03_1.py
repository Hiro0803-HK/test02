...
#       col1,col2,col3 = st.beta_columns(3)
 #      with col1:
  #         st.image("ほっそり.png",use_column_width=True)
           
   #    with col2:
    #       st.image("標準.png",use_column_width=True)
     
     #  with col3:
      #     st.image("がっちり.png",use_column_width=True)
      ...
      # st.write(YMsk,unsafe_allow_html=True)
